...
export default async function ColumnDetailPage({ params }: Props) {
  ...
  const articleSchema = {
    ...
    headline: col.title,
    description: col.description,
    datePublished: `${col.publishedAt}T00:00:00+09:00`,
    dateModified: `${col.publishedAt}T00:00:00+09:00`,
    inLanguage: "ja",
    image: {
      "@type": "ImageObject",
    ...
    wordCount: col.content.replace(/<[^>]*>/g, "").length,
    timeRequired: `PT${col.readMinutes}M`,
